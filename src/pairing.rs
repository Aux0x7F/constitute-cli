...
use constitute_protocol::{
    BootstrapNostrEvent, BootstrapNostrFilter, build_bootstrap_nostr_unsigned_event,
    frame_bootstrap_nostr_event, frame_bootstrap_nostr_req, parse_xonly_as_public_key,
    sign_bootstrap_nostr_event, verify_bootstrap_nostr_event,
};
use rand::Rng;
...
fn publish_pair_request(
    ...
    let event = sign_bootstrap_nostr_event(&unsigned, device_sk)?;
    let frame = frame_bootstrap_nostr_event(&event);
